...
const HomePage = () => {
  ...
  return (
    <div
      className="h-[150vh] md:h-[120vh] flex flex-col items-center mt-16 px-6 text-center relative"
      style={{
    ...
    >
      ...
      <div className="relative z-10 text-white text-3xl md:text-6xl font-extrabold mt-6 animate-fade-in tracking-wide drop-shadow-2xl transition-transform duration-300 transform hover:scale-110 hover:translate-y-[-4px]">
        {userData ? (
      ...
      <div className="flex flex-col items-center justify-start flex-grow z-10 mt-8">
        <div className="md:flex items-center space-y-10 md:gap-40 justify-start w-full">
          {/* Website description */}
          <div className="text-white text-lg md:text-2xl max-w-xl animate-slide-up drop-shadow-md leading-relaxed tracking-wide bg-white bg-opacity-10 hover:shadow-inner backdrop-filter backdrop-blur-lg rounded-xl p-6 shadow-2xl">
          ...
          {/* Images Section */}
          <div className="flex flex-col justify-center items-center gap-10 md:flex md:flex-row md:space-x-8 animate-zoom-in">
            <img
              src={teamImage}
              alt="Team collaboration"
              className="w-72 md:w-80   rounded-xl shadow-2xl transform hover:scale-110 hover:rotate-3 transition-transform duration-500 ease-in-out hover:shadow-blue-500"
            />
            <img
              src={reviewImage}
              alt="Employee review"
